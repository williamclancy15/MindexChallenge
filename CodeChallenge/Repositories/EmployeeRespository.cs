    ...
    public class EmployeeRespository : IEmployeeRepository
    {
        ...
        public Employee GetEmployeeById(string id)
        {
            return _employeeContext.Employees
                ...
                .ThenInclude(i => i.DirectReports) //this lets us see the next level of directReports
				.ThenInclude(o => o.DirectReports) //...and the next level after that. I think that's enough now
